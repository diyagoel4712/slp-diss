...
SRC=$SCRATCH/indicvoices_r/$IVLANG         # extracted IndicVoices-R for this language
MANIFEST="$SRC/*.jsonl"                  # manifest(s); glob is expanded by the script
AUDIO_ROOT=$SRC                          # root the manifest's filename paths resolve under
