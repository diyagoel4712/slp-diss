...
def main(config):
    ...
    ckpts_cfg = {
        ...
        "sample_per_updates": config.ckpts.get("sample_per_updates", None),
        "track_wer": config.ckpts.get("track_wer", False),
        "asr_language": config.ckpts.get("asr_language", None),
        "asr_model_name": config.ckpts.get("asr_model_name", "large-v3"),
        "snapshot_per_updates": config.ckpts.get("snapshot_per_updates", None),
