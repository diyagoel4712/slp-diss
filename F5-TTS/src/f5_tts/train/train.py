...
def main(model_cfg):
    ...
    trainer = Trainer(
        ...
        sample_per_updates=model_cfg.ckpts.get("sample_per_updates", None),
        track_wer=model_cfg.ckpts.get("track_wer", False),
        asr_language=model_cfg.ckpts.get("asr_language", None),
        asr_model_name=model_cfg.ckpts.get("asr_model_name", "large-v3"),
